...
const registerDoctor = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (payload.role !== 'doctor') {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Invalid role for doctor registration');
    }
...
const registerPatient = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (payload.role !== 'patient') {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Invalid role for patient registration');
    }
    const user = yield user_model_1.User.isUserExistByEmail(payload === null || payload === void 0 ? void 0 : payload.email);
    if (user)
        throw new AppError_1.default(http_status_1.default.CONFLICT, 'User already exists!');
